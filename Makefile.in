...
pkgdatadir = $(datadir)/libc
pkglibdir = $(libdir)/libc
pkgincludedir = $(includedir)/libc
top_builddir = .
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
ACLOCAL = ${SHELL} /cygdrive/k/gnu/libc/libc/missing --run aclocal-1.7
ALLOCA = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /cygdrive/k/gnu/libc/libc/missing --run tar
AUTOCONF = ${SHELL} /cygdrive/k/gnu/libc/libc/missing --run autoconf
AUTOHEADER = ${SHELL} /cygdrive/k/gnu/libc/libc/missing --run autoheader
AUTOMAKE = ${SHELL} /cygdrive/k/gnu/libc/libc/missing --run automake-1.7
AWK = gawk
CC = gcc
CCAS = $(CC)
CCASFLAGS = $(CFLAGS)
...
LDFLAGS =  -Wl,-s -Wl,--enable-auto-import -Wl,--enable-runtime-pseudo-reloc  
LIBOBJS =  error$U.o lstat$U.o
LIBS = -liberty -lintl -liconv -lwsock32 -lole32 -luuid
LTLIBOBJS =  error$U.lo lstat$U.lo
MAINT = #
MAINTAINER_MODE_FALSE = 
MAINTAINER_MODE_TRUE = #
MAKEINFO = ${SHELL} /cygdrive/k/gnu/libc/libc/missing --run makeinfo
OBJEXT = o
PACKAGE = libc
PACKAGE_BUGREPORT = gnuwin32@users.sourceforge.net
PACKAGE_NAME = libc
PACKAGE_STRING = libc 0.3
PACKAGE_TARNAME = libc
PACKAGE_VERSION = 0.3
PATH_SEPARATOR = :
RANLIB = ranlib
SET_MAKE = 
...
infodir = ${prefix}/info
install_sh = /cygdrive/k/gnu/libc/libc/install-sh
...
SUBLIBDIRS = \
aout argp catgets crypt csu ctype dirent dl fpu grp \
...
libc_dll_a_AR = $(AR) cru
libc_dll_a_LIBADD =
am_libc_dll_a_OBJECTS =
libc_dll_a_OBJECTS = $(am_libc_dll_a_OBJECTS)
libgw32c_a_AR = $(AR) cru
libgw32c_a_LIBADD =
am_libgw32c_a_OBJECTS =
libgw32c_a_OBJECTS = $(am_libgw32c_a_OBJECTS)
...
DIST_SOURCES = $(libc_a_SOURCES) $(libc_dll_a_SOURCES) \
	$(libgw32c_a_SOURCES)
...
DIST_COMMON = README $(srcdir)/./make.common $(srcdir)/Makefile.in \
	$(srcdir)/configure AUTHORS COPYING COPYING.LIB ChangeLog \
	INSTALL Makefile.am NEWS acconfig.h aclocal.m4 config.h.in \
	configure configure.ac depcomp install-sh missing mkinstalldirs
DIST_SUBDIRS = $(SUBDIRS)
SOURCES = $(libc_a_SOURCES) $(libc_dll_a_SOURCES) $(libgw32c_a_SOURCES)
...
libc.dll.a: libc.a libc-rc.o
	a2dll libc.a -o libc.dll -lintl -liconv -liberty -lwsock32 -lole32 -luuid
